...
function Home() {
  ...
  const makereserva = useNavigate();

  console.log("Date", date);
  return (
    <div className="">
      <div className="w-[100%] mx-auto flex-row p-4 bg-sky-50">
        <h1 className="font-sono text-center text-black text-3xl font-bold">
          Book Your Table
        </h1>
        <div className="flex flex-col lg:flex-row h-[150px] justify-center items-center w-[100%]">
          ...
          <div className="w-[100%] lg:w-[40%] lg:space-x-6 flex space-x-1 items-center bg-white rounded-xl p-2 m-1 shadow-lg">
            <div className="flex items-center">
              <input
                className="flex items-center bg-transparent  w-full focus:outline-none font-poppins text-slate-500"
                type="date"
            ...
            <div className="flex items-center">
              ...
              <select className="font-poppins text-slate-600 bg-transparent w-[100%] focus:outline-none">
                ...
                <option selected className="font-poppins text-slate-700">
                  1 person
                </option>
                <option className="font-poppins text-slate-700">
                  2 persons
                </option>
                <option className="font-poppins text-slate-700">
                  3 persons
      ...
      <div className="max-w-full mx-auto p-4 py-10 grid md:grid-cols-2 gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl relative">
          ...
          <img
            className="rounded-3xl max-h-[160px] md:max-h-[250px] w-full object-cover"
        ...
        <div className="rounded-xl relative">
          ...
          <img
            className="rounded-3xl max-h-[160px] md:max-h-[220px] w-full object-cover"
            src="https://images.pexels.com/photos/299347/pexels-photo-299347.jpeg?auto=compress&cs=tinysrgb&w=1600"
            alt="/"
          />
        </div>
        <div className="rounded-xl relative">
