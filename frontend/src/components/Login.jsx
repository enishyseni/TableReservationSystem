     ...
     <div className='main flex flex-col justify-evenly items-center'>
        ...
        <div className="font-poppins h-35 w-64 text-white bg-black text-2xl tracking-wider py-2 px-5 rounded-full -mt-3"><span className='px-12'>Welcome</span></div>
          <form className="h-full flex flex-col justify-evenly items-center">
              ...
              <button onClick={() => link("/register")} className="font-poppin text-black text-xs tracking-wider hover:text-gray-900 -mt-6" >Register as client </button>
              <button onClick={() => history("/addrestaurant")} className="font-poppin text-black text-xs tracking-wider hover:text-gray-900 -mt-6" >Register as business </button>
