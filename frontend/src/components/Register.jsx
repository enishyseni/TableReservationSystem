  ...
  const back = useNavigate ();
    return (
     ...
     <div className='main flex flex-col flex-initial justify-evenly items-center'>
        ...
        <div className=" flex flex-col items-center container h-96 md:h-[444px] md:w-[444px] bg-gray-900 bg-opacity-10 rounded-2xl shadow-5xl relative z-2 border border-opacity-30 border-r-0 border-b-0 backdrop-filter backdrop-blur-sm">
        <div className="font-poppins h-35 w-64 text-white bg-black text-2xl tracking-wider py-2 px-5 rounded-full -mt-3"><span className='px-12'>Register</span></div>
          <form className="h-full w-5/6 flex flex-col justify-evenly items-stretch">
            ...
            <button onClick={() => back("/login")}><BiArrowBack/></button>
            <button  className='font-poppins text-white bg-black w-[115px] cursor-pointer text-xl rounded-full px-5 py-1 bg-opacity-60 hover:bg-black hover:bg-opacity-80 tracking-wider'>Confirm</button>
            </div>
